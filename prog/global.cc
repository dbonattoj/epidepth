...
const std::size_t image_count = 10;
const ndsize<2> image_shape = make_ndsize(5490/4, 3450/4);
*/



const char* image_path_format = "../data/mansion_colordiff/mansion_image_%04d.jpg";
const std::size_t image_count = 10;
const ndsize<2> image_shape = make_ndsize(5490/6, 3450/6);
...
ndarray<3, rgba_color> epis(make_ndsize(v_sz, u_sz, s_sz));
